...
@NullMarked
public record ServerVersionData(String software, String version, int build) {

    public static ServerVersionData from(final Tuple2<VersionSoftwareRecord, VersionVersionRecord> tuple) {
